  ...
  void initializeRealWorldEvents() {
    ...
    _events.addAll([
      ...
      EventModel(
        ...
        location: 'Houston, TX',
        startTime: now.add(Duration(days: 7)).copyWith(hour: 21, minute: 0),
        endTime: now.add(Duration(days: 8)).copyWith(hour: 3, minute: 0),
        type: EventType.clubNight,
        artists: ['Boris Brejcha', 'Ann Clue'],
        description: 'High-Tech Minimal master returns to Houston',
        price: 45.00,
        ticketUrl: 'https://stereolivehouston.com',
        source: EventSource.ticketmaster,
        genres: ['Techno', 'Minimal', 'Progressive'],
        capacity: 1200,
        latitude: 29.7604,
        longitude: -95.3698,
        interestedCount: 950,
      ...
      EventModel(
        id: 'cle_houston',
        name: 'Clé Summer Sessions',
        venue: 'Clé Houston',
        location: 'Houston, TX',
        startTime: now.add(Duration(days: 1)).copyWith(hour: 13, minute: 0),
        endTime: now.add(Duration(days: 1)).copyWith(hour: 22, minute: 0),
        type: EventType.clubNight,
        artists: ['Local DJs', 'Special Guests'],
        description: 'Pool party with house music all day',
        price: 30.00,
        ticketUrl: 'https://clehouston.com',
        source: EventSource.eventbrite,
      ...
      EventModel(
        ...
        location: 'Houston, TX',
        startTime: now.add(Duration(days: 14)).copyWith(hour: 23, minute: 0),
        endTime: now.add(Duration(days: 15)).copyWith(hour: 6, minute: 0),
        type: EventType.warehouse,
        artists: ['Green Velvet', 'Patrick Topping'],
        description: 'Underground warehouse vibes. Location TBA.',
        price: 40.00,
        ticketUrl: 'https://ra.co',
        source: EventSource.residentAdvisor,
      ...
      EventModel(
        id: 'sekai_houston',
        name: 'Sekai Night Market Festival',
        venue: 'NRG Park',
        location: 'Houston, TX',
        startTime: now.add(Duration(days: 45)).copyWith(hour: 16, minute: 0),
        endTime: now.add(Duration(days: 46)).copyWith(hour: 23, minute: 0),
        type: EventType.festival,
        artists: ['Porter Robinson', 'Madeon', 'San Holo', 'Dabin'],
        description: 'Electronic meets anime culture festival',
        price: 125.00,
        ticketUrl: 'https://sekainightmarket.com',
        source: EventSource.ticketmaster,
        genres: ['Future Bass', 'Electronic', 'Melodic Dubstep'],
        capacity: 15000,
        latitude: 29.6847,
        longitude: -95.4052,
      ...
      EventModel(
        id: 'numbers_houston',
        name: 'Acid House Night',
        venue: 'Numbers',
        location: 'Houston, TX',
        startTime: now.add(Duration(days: 9)).copyWith(hour: 22, minute: 0),
        endTime: now.add(Duration(days: 10)).copyWith(hour: 4, minute: 0),
        type: EventType.underground,
        artists: ['DJ Pierre', 'Phuture'],
        description: '303 acid house all night long',
        price: 25.00,
        ticketUrl: 'https://numbersnightclub.com',
        source: EventSource.dice,
